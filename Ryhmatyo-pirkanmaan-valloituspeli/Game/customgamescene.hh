#ifndef CUSTOMGAMESCENE_HH
#define CUSTOMGAMESCENE_HH
...
/**
 * @brief The CustomGameScene is a custom QGraphicsScene that shows
...
public:
     ...
     */
    CustomGameScene(QWidget* qt_parent = nullptr,
                    int width = 10,
                    int height = 10,
                    int scale = 50
            );
...
signals:
    ...
    /**
     * @brief signal coordinates from mouse click event.
     * @param mouse click coordinates.
     */
    void pointGiver(QPointF point);
