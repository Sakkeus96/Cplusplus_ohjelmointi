#ifndef CUSTOMMAPITEM_HH
#define CUSTOMMAPITEM_HH
...
/**
 * @brief The CustomMapItem class is a custom QGraphicsItem that
 * acts as a single GameObject's graphical element.
 */
class CustomMapItem : public QGraphicsItem
{
public:
    /**
     * @brief Constructor
     ...
     */
    CustomMapItem(const std::shared_ptr<Course::GameObject> &obj, int size);
